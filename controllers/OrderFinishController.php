...
*/
        case "getOrders":
            ...
            //쿼리스트링 태그값 가져오기
            if(empty($_GET["item_id"])){
                $res->result = getOrders($user_id,$page);
                $res->is_success = TRUE;
                $res->code = 100;
            ...
            $res->result = getOrdersWithItem($user_id,$item_id,$page);
            $res->is_success = TRUE;
            $res->code = 100;
            $res->message = "주문 완료 조회가 완료되었습니다.";
            echo json_encode($res, JSON_NUMERIC_CHECK);
...
*/
        case "getOrderDetail":
            ...
            $res->result = getOrderDetail($user_id,$order_id);
            $res->is_success = TRUE;
            $res->code = 100;
            $res->message = "주문 완료 조회가 완료되었습니다.";
            echo json_encode($res, JSON_NUMERIC_CHECK);
...
*/
        case "deleteOrder":
            ...
            $res->result = deleteOrder($user_id, $item_id);
            $res->is_success = TRUE;
            $res->code = 100;
